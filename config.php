...
<?php include_once("./cuerpos/menu.php") ?>
    ...
    <div class="container"  style="height:1100px"  >                        
                    <div class=" mt-5">
                    <h3>Configurar Contenido de Select en Formularios</h3>
                                   ...
                                   <div class="container">
                                    <label id="title"><i class="fi fi-sr-person-dolly"></i>Profesion Nueva </label>
                                       ...
                                       <button id="addProfe" class="btn btn-primary mt-3 mb-3 mx-auto btn-lg w-100">Ingresar</button>
                                        <button id="cerrarVentana"  class="btn btn-danger mt-1 mb-3 mx-auto btn-lg w-100">Cerrar</button>
                                   </div>
                                   <div class="container">
...
document.getElementById('cerrarVentana').addEventListener('click',()=>{
    document.getElementById('contenedor').style.display='none'
    document.getElementById('addProfe').setAttribute('id','todero')
})
